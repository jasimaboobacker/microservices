package com.jasim.microservices.kafka.admin.client;

import com.jasim.microservices.config.KafkaConfigData;
import com.jasim.microservices.config.RetryConfigData;
import com.jasim.microservices.kafka.admin.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    private void sleep(Long sleepTimeMs){
        try {
            ...
            throw new KafkaClientException("Error while sleeping for waiting new creating topics");
        }
    }
